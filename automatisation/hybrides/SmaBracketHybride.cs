...
/// <summary>
/// H1 — Croisement SMA 2/6 (1 m) + bracket · mécanique : cassure de momentum · PROUVE :
...
///   - Signal : croisement SMA 2/6 sur closes 1 m (seedé par GetHistory).
///   - Entrée : croisement → market ×1 + bracket SL/TP ATTACHÉ (offsets en ticks du fill).
///   - SL = 1,0 × ATR14 (1 m, valeur au signal) | TP = 1R. Pas de stop suiveur.
...
public sealed class SmaBracketHybride : HybrideStrategyBase
{
    ...
    public SmaBracketHybride()
    {
        ...
        Description = "Croisement SMA 2/6 (1 m) + bracket SL/TP attaché — jumeau LEAN : sma_bracket_nq.py";
    }
