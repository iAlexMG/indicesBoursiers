...
/// <summary>
/// H1 — Croisement SMA 3/9 (1 m) + bracket · mécanique : cassure de momentum · PROUVE :
...
///   - Signal : croisement SMA 3/9 sur closes 1 m (seedé par GetHistory).
...
public sealed class SmaBracketHybride : HybrideStrategyBase
{
    ...
    {
        Name = "SMA Bracket";
        Description = "Croisement SMA 3/9 (1 m) + bracket SL/TP attaché — jumeau LEAN : sma_bracket_nq.py";
    }
