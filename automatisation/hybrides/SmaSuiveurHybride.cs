...
/// <summary>
/// H2 — Croisement SMA 9/21 (1 m) + stop suiveur · mécanique : tendance · PROUVE : la
...
public sealed class SmaSuiveurHybride : HybrideStrategyBase
{
    ...
    public SmaSuiveurHybride()
    {
        ...
        Description = "Croisement SMA 9/21 (1 m) + stop suiveur par modification d'ordre — jumeau LEAN : sma_suiveur_nq.py";
    }
